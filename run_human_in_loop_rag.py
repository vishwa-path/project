...
def human_review_decision(
    ...
    poison_retrieved = any(c.get("is_poison", False) for c in retrieved_chunks)
    ...
    if needs_review:
        return {
            "final_answer": trusted_answer or "Not found in retrieved documents.",
            "sent_to_human": True,
...
def evaluate_queries(
    ...
    for item in queries:
        ...
        model_answer = review["final_answer"]
