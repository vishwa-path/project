...
def evaluate_poisoned_queries(
    ...
    summary = {
        ...
        "targeted_poison_retrieval_rate": (
            sum(1 for r in results if r["targeted_poison_retrieved"]) / total
            if total else 0.0
        ),
    ...
    print("\nSaved poisoned results to:", output_path)
...
def main():
    ...
    evaluate_poisoned_queries(
        ...
        output_path=DATA_DIR / "poisoned_results.json",
        top_k=TOP_K,
    )
